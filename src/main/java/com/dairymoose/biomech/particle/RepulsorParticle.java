...
public class RepulsorParticle extends TextureSheetParticle {
	private final SpriteSet sprites;
	
	private Player player = null;
	private float savedQuadSize = 0.0f;
	public RepulsorParticle(ClientLevel p_171904_, double x, double y, double z, float p_171908_, float p_171909_, float p_171910_, double d4, double d5, double d6, float p_171914_, SpriteSet p_171915_, float p_171916_, int p_171917_, float p_171918_, boolean p_171919_) {
		super(p_171904_, x, y, z, 0.0D, 0.0D, 0.0D);
		player = RepulsorLiftArmor.currentPlayer;
	...
	public void tick() {
		...
		if (player != null) {
			...
			double deltaZ = player.getZ() - this.z;
			if (deltaX != 0.0 || deltaZ != 0.0)
				this.move(deltaX, 0.0, deltaZ);
		}
	...
	protected RepulsorParticle(ClientLevel p_107685_, double p_107686_, double p_107687_, double p_107688_, double p_107689_, double p_107690_, double p_107691_, float p_107692_, SpriteSet p_107693_) {
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public TextureSheetParticle createParticle(SimpleParticleType p_105804_, ClientLevel p_105805_, double p_105806_, double p_105807_, double p_105808_, double p_105809_, double p_105810_, double p_105811_) {
			RepulsorParticle repulsorParticle = new RepulsorParticle(p_105805_, p_105806_, p_105807_, p_105808_, p_105809_, p_105810_, p_105811_, 1.0f, sprite);
			repulsorParticle.pickSprite(this.sprite);
			return repulsorParticle;
      }
   }
}