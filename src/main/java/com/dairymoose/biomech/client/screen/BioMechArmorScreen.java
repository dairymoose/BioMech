...
@OnlyIn(Dist.CLIENT)
public class BioMechArmorScreen extends AbstractContainerScreen<HopperMenu> {
   private static final ResourceLocation HOPPER_LOCATION = new ResourceLocation("textures/gui/container/hopper.png");

   public BioMechArmorScreen(HopperMenu p_98798_, Inventory p_98799_, Component p_98800_) {
