...
public abstract class PipeMechArmArmor extends ArmorBase {

	public PipeMechArmArmor(Holder<ArmorMaterial> p_40386_, Type p_266831_, Properties p_40388_) {
		super(p_40386_, p_266831_, p_40388_);
		this.suitEnergy = 5;
		this.hidePlayerModel = true;
		this.mechPart = MechPart.RightArm;
		this.damageAvoidPct = 0.02f;
	}

	@Override
	public Item getLeftArmItem() {
		return BioMechRegistry.ITEM_PIPE_MECH_LEFT_ARM.get();
	}
