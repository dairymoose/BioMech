...
public class IronMechLegsArmor extends ArmorBase {

	public IronMechLegsArmor(Holder<ArmorMaterial> p_40386_, Type p_266831_, Properties p_40388_) {
    ...
    public void biomechInventoryTick(SlottedItem slottedItem, ItemStack itemStack, Level level, Entity entity, int slotId, boolean isSelected) {
        if (entity instanceof Player player) {
			...
			if (armorItems.contains(BioMechRegistry.ITEM_IRON_MECH_LEGS.get()) || slotId == -1) {
