...
public class ColossusChestplateArmor extends ArmorBase {

	public ColossusChestplateArmor(Holder<ArmorMaterial> p_40386_, Type p_266831_, Properties p_40388_) {
		super(p_40386_, p_266831_, p_40388_);
		this.suitEnergy = 100;
		this.suitEnergyPerSec = 1.0f;
		this.hidePlayerModel = true;
		this.mechPart = MechPart.Chest;
		this.armDistance = 9.5f;
		float upwardsDist = 4.0f;
	...
	public void biomechInventoryTick(SlottedItem slottedItem, ItemStack itemStack, Level level, Entity entity, int slotId, boolean isSelected) {
		if (entity instanceof Player player) {
			...
			if (armorItems.contains(BioMechRegistry.ITEM_COLOSSUS_CHESTPLATE.get()) || slotId == -1) {
