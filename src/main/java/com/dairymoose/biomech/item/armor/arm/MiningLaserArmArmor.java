...
public abstract class MiningLaserArmArmor extends AbstractMiningArmArmor {
	...
	public MiningLaserArmArmor(Holder<ArmorMaterial> p_40386_, Type p_266831_, Properties p_40388_) {
		super(p_40386_, p_266831_, p_40388_);
		this.suitEnergy = 10;
		this.hidePlayerModel = true;
		this.dispatcher = new MiningLaserDispatcher();
		
		this.minSpeedMult = 2.9f;
		this.maxSpeedMult = minSpeedMult * MAX_POWER;
		
		this.energyPerSec = 4.0f;
		this.blockReachMult = 1.7;
		
		this.firstPersonStandNextToDist = 0.1945;
	}

	public static float laserDamageAtMaxPower = 7.6f;
