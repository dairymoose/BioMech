...
public class BioMechServerConfig {
	...
	public BioMechServerConfig(ForgeConfigSpec.Builder builder) {		
		...
		this.gatlingDamage = builder.comment("gatlingDamage").translation("config.biomech.gatlingDamage").define("gatlingDamage", 25.0);
		this.gatlingEnergyPerSec = builder.comment("gatlingEnergyPerSec").translation("config.biomech.gatlingEnergyPerSec").define("gatlingEnergyPerSec", 16.0);
		builder.pop();
	}
